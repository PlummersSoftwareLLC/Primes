...
function main() {
    ...
    if (isHelp) {
        ...
        while (                                      
                   (new Date() - timeStart < timeoutInMs && maxNrOfPasses == -1) // Run until more than 5 seconds have elapsed
        ...
        var timeDeltaInMs = new Date() - timeStart; // After the "at least 5 seconds", get the actual elapsed
