...
function main() {
  ...
  if (validResult) {
    const scriptOrCompiled = Deno.env.get("IS_COMPILED") === "0"
      ...
      : "-compiled";
    console.log(
      `\nhktr92-deno-js${scriptOrCompiled};${totalPasses};${durationInSec};1;algorithm=base,faithful=yes,bits=1`,
    );
  }
  ...
  if (verbose) {
    ...
    console.log(
      `Passes: ${nrOfPasses}, Time: ${parseFloat(durationInSec).toFixed(2)},`,
