...
class prime_sieve(object):
    ...
    def __init__(this, limit):
        ...
        this.rawbits = [True] * ((this.sieveSize+1)>>1)
    ...
    def runSieve(this):
        for factor in filter(this.GetBit, range(3, int(sqrt(this.sieveSize)), 2)):
