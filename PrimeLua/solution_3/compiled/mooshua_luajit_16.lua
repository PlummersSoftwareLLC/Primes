...
return function(ARENA, TIME)
    ...
    while (clock()-begin) <= TIME do
		...
		ARENA[ rshift( x + vk + vk + vk + vk + vk + vk + vk + vk , 1) ] = 1;
		ARENA[ rshift( x + vk + vk + vk + vk + vk + vk + vk + vk + vk , 1) ] = 1;
		ARENA[ rshift( x + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk , 1) ] = 1;
		ARENA[ rshift( x + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk , 1) ] = 1;
		ARENA[ rshift( x + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk , 1) ] = 1;
		ARENA[ rshift( x + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk + vk , 1) ] = 1;
