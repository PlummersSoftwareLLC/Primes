...
local myDict = 
{ 
	k10 = 1 ,        --Historical data for validating our results - the number of primes   
...
function runSieve()
	...
	while factor < q do
		...
		for num = factor * 3, sieveSize-1, factor * 2 do
			clearBit(num)
		end
...
local target = tonumber(arg[1] or 1000)
local duration = tonumber(arg[2] or 2)
