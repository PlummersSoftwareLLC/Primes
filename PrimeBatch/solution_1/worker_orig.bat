@echo off
:: this is the slow original version.  its not correct and misses some primes.
:: its also got a buggy sqrt function.  We did update the timing logic so we
:: could compare it to improved versions.
...
title %options.title%
echo starting worker_orig sieve...
